...
namespace MentalVerse.Web.Api.Migrations
{
    ...
    [Migration("20190909173924_CompanyDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MentalVerse.Web.Api.Models.Company", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MentalVerse.Web.Api.Models.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MentalVerse.Web.Api.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MentalVerse.Web.Api.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
